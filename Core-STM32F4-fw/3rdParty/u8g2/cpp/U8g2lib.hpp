...
class SH1107 : public U8G2 {
private:

public:
    explicit SH1107(I2C_HandleTypeDef *_hi2c, const u8g2_cb_t *rotation = U8G2_R3) : U8G2() {
        U8G2_I2C_HANDLE = _hi2c;
        u8g2_Setup_sh1107_i2c_128x80_f(&u8g2, rotation, u8x8_byte_stm32_hw_i2c, u8x8_stm32_gpio_and_delay);
    }
};
